...
// WatchFolder.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CWatchFolderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CWatchFolderApp

CWatchFolderApp::CWatchFolderApp()
{
...
// Единственный объект CWatchFolderApp

CWatchFolderApp theApp;


// Инициализация CWatchFolderApp

BOOL CWatchFolderApp::InitInstance()
{
